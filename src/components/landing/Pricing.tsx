  ...
  const plans = [
    {
      ...
      features: [
        t("50 pesan AI/hari", "50 AI messages/day"),
        t("5 reminder aktif", "5 active reminders"),
        t("10 tugas", "10 tasks"),
        t("Push notification", "Push notifications"),
      ],
    ...
    },
    {
      ...
      features: [
        t("Pesan AI unlimited", "Unlimited AI messages"),
        t("Reminder unlimited", "Unlimited reminders"),
        t("Tugas unlimited", "Unlimited tasks"),
        t("Telegram reminder", "Telegram reminders"),
        t("Focus mode", "Focus mode"),
        t("Streak & XP", "Streaks & XP"),
      ],
    ...
    },
    {
      ...
      features: [
        t("Semua di Pro", "Everything in Pro"),
        t("AI model premium", "Premium AI model"),
        t("Analitik produktivitas", "Productivity analytics"),
        t("Custom persona AI", "Custom AI persona"),
        t("Support prioritas", "Priority support"),
      ],
      cta: t("Pilih Max", "Get Max"),
      highlight: false,
    },
  ];
